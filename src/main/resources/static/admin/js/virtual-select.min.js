...
!function () {
    ...
    var s = function () {
        ...
        return s = t, r = [{
            ...
            key: "regexEscape", value: function (e) {
                return e.replace(/[-/\\^$*+?.()|[\]{}]/g, "\\$&")
            }
    ...
    function r(e, t) {
        return function (e) {
            ...
            if (null != i) {
                var o, s, n, r, a = [], l = !0, u = !1;
                try {
                    if (n = (i = i.call(e)).next, 0 === t) {
                        if (Object(i) !== i) return;
                        l = !1
                    } else for (; !(l = (o = n.call(i)).done) && (a.push(o.value), a.length !== t); l = !0) ;
                } catch (e) {
                    u = !0, s = e
                } finally {
                    try {
    ...
    var h = function () {
        ...
        }], (i = null) && p(t.prototype, i), o && p(t, o), Object.defineProperty(t, "prototype", {writable: !1}), e
    }();
    ...
    var x, w = {13: "onEnterPress", 38: "onUpArrowPress", 40: "onDownArrowPress"},
        ...
        A = function () {
            ...
            return t = e, o = [{
                ...
                key: "getAttrProps", value: function () {
                    var e = h.convertPropToDataAttr, t = {};
                ...
                key: "setPropsFromSelect", value: function (e) {
                    ...
                    h.setAttrFromEle(t, n, Object.keys(x), k), t.parentNode.insertBefore(n, t), t.remove(), e.ele = n, e.options = s, e.disabledOptions = i, e.selectedValue = o
                }
            }, {
                ...
                key: "renderDropbox", value: function (e) {
                    ...
                    if (i) {
                        ...
                        return this.$dropboxWrapper = s, this.hasDropboxWrapper = !0, s.innerHTML = o, i.appendChild(s), h.addClass(s, "vscomp-dropbox-wrapper ".concat(t)), ""
                    }
                ...
                key: "addEvent", value: function (e, t, i) {
                    ...
                    e && s.removeArrayEmpty(t.split(" ")).forEach((function (t) {
                        ...
                        n || (n = o[i].bind(o), o.events[s] = n), h.addEvent(e, t, n)
                    }))
                }
            }, {
                ...
                key: "onOptionsClick", value: function (e) {
                    ...
                    t && !h.hasClass(t, "disabled") && (h.hasClass(t, "group-title") ? this.onGroupTitleClick(t) : this.selectOption(t, {event: e}))
                }
            }, {
                ...
                key: "onOptionsMouseOver", value: function (e) {
                    var t = e.target.closest(".vscomp-option");
                    t && this.isOpened() && (h.hasClass(t, "disabled") || h.hasClass(t, "group-title") ? this.removeOptionFocus() : this.focusOption({$option: t}))
                }
            }, {
                ...
                key: "afterRenderWrapper", value: function () {
                    h.addClass(this.$ele, "vscomp-ele"), this.renderSearch(), this.setEleStyles(), this.setDropboxStyles(), this.setOptionsHeight(), this.setVisibleOptions(), this.setOptionsContainerHeight(), this.addEvents(), this.setEleProps(), this.keepAlwaysOpen || this.showAsPopup || this.initDropboxPopover(), this.initialSelectedValue ? this.setValueMethod(this.initialSelectedValue, this.silentInitialValueSet) : this.autoSelectFirstOption && this.visibleOptions.length && this.setValueMethod(this.visibleOptions[0].value, this.silentInitialValueSet), this.showOptionsOnlyOnSearch && this.setSearchValue("", !1, !0), this.initialDisabled && this.disable(), this.autofocus && this.focus()
                }
            }, {
                key: "afterRenderOptions", value: function () {
                    var e = this.getVisibleOptions(), t = !this.options.length && !this.hasServerSearch,
                        i = !t && !e.length;
                    (!this.allowNewOption || this.hasServerSearch || this.showOptionsOnlyOnSearch) && h.toggleClass(this.$allWrappers, "has-no-search-results", i), h.toggleClass(this.$allWrappers, "has-no-options", t), this.setOptionAttr(), this.setOptionsPosition(), this.setOptionsTooltip()
                }
            }, {
                ...
                key: "setPropsFromElementAttr", value: function (e) {
                    ...
                    Object.keys(x).forEach((function (i) {
                        ...
                        -1 === k.indexOf(i) || "" !== o && "true" !== o || (o = !0), o && (e[x[i]] = o)
                    }))
                }
            }, {
                ...
                key: "setOptions", value: function () {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], t = [],
                        ...
                        h = this.secureText.bind(this), c = this.getAlias.bind(this), d = 0, y = !1, b = {}, g = !1;
                    ...
                    var m = function e(s) {
                        ...
                        if (g || "" !== O || (g = !0), i && (w.isDisabled = !0 === b[O]), s.isGroupOption && (w.isGroupOption = !0, w.groupIndex = s.groupIndex), l && (w.description = h(u(s[r]))), s.customData && (w.customData = s.customData), t.push(w), d += 1, x) {
                            var k = w.index;
                ...
                key: "setServerOptions", value: function () {
                    ...
                    s ? (this.setVisibleOptionsCount(), this.multiple && this.toggleAllOptionsClass(), this.setValueText()) : this.updatePosition(), h.removeClass(this.$allWrappers, "server-searching")
                }
            }, {
                ...
                key: "setVisibleOptions", value: function () {
                    var e = b(this.sortedOptions), t = 2 * this.optionsCount, i = this.getVisibleStartIndex(),
                ...
                key: "setOptionsPosition", value: function (e) {
                    ...
                    this.$options.style.transform = "translate3d(0, ".concat(t, "px, 0)"), h.setData(this.$options, "top", t)
                }
            }, {
                key: "setOptionsTooltip", value: function () {
                    ...
                    t.forEach((function (t) {
                        ...
                        h.setData(o.querySelector(".vscomp-option-text"), "tooltip", t.label), i && h.setData(o.querySelector(".vscomp-option-description"), "tooltip", t.description)
                    }))
                }
            }, {
                ...
                key: "setValueText", value: function () {
                    ...
                    if (u && this.hideValueTooltipOnSelectAll) s.innerHTML = "".concat(this.allOptionsSelectedText, " (").concat(a, ")"); else {
                        ...
                        if ("" === c) s.innerHTML = this.placeholder; else if (s.innerHTML = c, e) {
                            ...
                            if (this.alwaysShowSelectedOptionsCount || h.hasEllipsis(s) || d || o) {
                    ...
                    var y = "";
                    0 === a ? y = this.placeholder : o || (y = r.join(", ")), h.setData(s, "tooltip", y), e && (h.setData(s, "tooltipEllipsisOnly", 0 === a), o && this.updatePosition())
                }
            }, {
                key: "setSearchValue", value: function (e) {
                    ...
                    if (e !== this.searchValueOriginal || i) {
                        ...
                        this.searchValue = o, this.searchValueOriginal = e, h.toggleClass(this.$allWrappers, "has-search-value", e), this.afterSetSearchValue()
                    }
                }
            }, {
                ...
                key: "setDropboxStyles", value: function () {
                    ...
                    e && (this.showAsPopup ? t["max-width"] = e : i.width = e), h.setStyles(this.$dropboxContainer, i), h.setStyles(this.$dropbox, t)
                }
            }, {
                key: "setOptionAttr", value: function () {
                    var e = this.$visibleOptions, t = this.options, i = "".concat(this.optionHeight, "px"),
                        o = h.setStyle, s = h.getData, n = h.setData;
                ...
                key: "setValueTagAttr", value: function () {
                    ...
                    if (e && e.length) {
                        var t = h.getData, i = h.setData, o = this.options;
                        e.forEach((function (e) {
                            var s = t(e, "index");
                            if (void 0 !== s) {
                                var n = o[s];
                ...
                key: "getSibling", value: function (e, t) {
                    ...
                    do {
                        o && (o = o[i])
                    } while (h.hasClass(o, "disabled") || h.hasClass(o, "group-title"));
                    return o
                }
            }, {
                ...
                key: "openDropbox", value: function (e) {
                    this.isSilentOpen = e, e ? h.setStyle(this.$dropboxContainer, "display", "inline-flex") : (h.dispatchEvent(this.$ele, "beforeOpen"), h.setAria(this.$wrapper, "expanded", !0)), this.setDropboxWrapperWidth(), h.removeClass(this.$allWrappers, "closed"), this.dropboxPopover && !e ? this.dropboxPopover.show() : this.afterShowPopper()
                }
            }, {
                key: "afterShowPopper", value: function () {
                    var e = this.isSilentOpen;
                    this.isSilentOpen = !1, e || (this.moveSelectedOptionsFirst(), this.setScrollTop(), h.addClass(this.$allWrappers, "focused"), this.showAsPopup ? (h.addClass(this.$body, "vscomp-popup-active"), this.isPopupActive = !0) : this.focusSearchInput(), h.dispatchEvent(this.$ele, "afterOpen"))
                }
            }, {
                key: "closeDropbox", value: function (e) {
                    this.isSilentClose = e, this.keepAlwaysOpen ? this.removeOptionFocus() : (e ? h.setStyle(this.$dropboxContainer, "display", "") : (h.dispatchEvent(this.$ele, "beforeClose"), h.setAria(this.$wrapper, "expanded", !1), h.setAria(this.$wrapper, "activedescendant", "")), this.dropboxPopover && !e ? this.dropboxPopover.hide() : this.afterHidePopper())
                }
            }, {
                key: "afterHidePopper", value: function () {
                    var e = this.isSilentClose;
                    this.isSilentClose = !1, h.removeClass(this.$allWrappers, "focused"), this.removeOptionFocus(), !e && this.isPopupActive && (h.removeClass(this.$body, "vscomp-popup-active"), this.isPopupActive = !1), h.addClass(this.$allWrappers, "closed"), e || h.dispatchEvent(this.$ele, "afterClose")
                }
            }, {
                ...
                key: "focusOption", value: function () {
                    ...
                    if (o) e = o; else if (!n || s) {
                        ...
                        e = this.$dropboxContainer.querySelector('.vscomp-option[data-visible-index="'.concat(r, '"]')), (h.hasClass(e, "disabled") || h.hasClass(e, "group-title")) && (e = this.getSibling(e, "next"))
                    } else e = this.getSibling(n, i);
                    e && e !== n && (n && this.toggleOptionFocusedState(n, !1), this.toggleOptionFocusedState(e, !0), this.toggleFocusedProp(h.getData(e, "index"), !0), this.moveFocusedOptionToView(e))
                }
            }, {
                key: "moveFocusedOptionToView", value: function (e) {
                    ...
                    if (t) {
                        var i, o = this.$optionsContainer.getBoundingClientRect(), s = t.getBoundingClientRect(),
                            n = o.top, r = o.bottom, a = o.height, l = s.top, u = s.bottom, p = s.height,
                            c = t.offsetTop, d = h.getData(this.$options, "top", "number");
                        n > l ? i = c + d : r < u && (i = c - a + p + d), void 0 !== i && (this.$optionsContainer.scrollTop = i)
                    }
                }
            }, {
                ...
                key: "selectOption", value: function (e) {
                    ...
                    if (e) {
                        ...
                        var n = this.selectedValues, r = h.getData(e, "value"), a = h.getData(e, "index", "number"),
                            l = h.hasClass(e, "current-new"), u = !1, p = this.lastSelectedOptionIndex;
                ...
                key: "toggleAllOptions", value: function (e) {
                    if (this.multiple && !this.disableSelectAll) {
                        var t = "boolean" == typeof isSelected ? e : !h.hasClass(this.$toggleAllCheckbox, "checked"),
                ...
                key: "toggleAllOptionsClass", value: function (e) {
                    if (this.multiple) {
                        var t = !1;
                        "boolean" == typeof e || (e = this.isAllOptionsSelected()), !e && this.selectAllOnlyVisible && (t = this.isAllOptionsSelected(!0)), h.toggleClass(this.$toggleAllCheckbox, "checked", e || t), this.isAllSelected = e
                    }
                }
            }, {
                ...
                key: "toggleGroupOptions", value: function (e, t) {
                    var i = this;
                    if (this.hasOptionGroup && !this.disableOptionGroupCheckbox && e) {
                        var o = h.getData(e, "index", "number"), n = this.selectedValues, r = this.selectAllOnlyVisible,
                ...
                key: "reset", value: function () {
                    ...
                    this.options.forEach((function (e) {
                        e.isSelected = !1
                    })), this.beforeValueSet(!0), this.setValue(null, {disableValidation: e}), this.afterValueSet(), e && h.removeClass(this.$allWrappers, "has-error"), h.dispatchEvent(this.$ele, "reset")
                }
            }, {
                key: "addOption", value: function (e, t) {
                    if (e) {
                        this.lastOptionIndex += 1;
                        var i = this.getOptionObj(d(d({}, e), {}, {index: this.lastOptionIndex}));
                ...
                key: "serverSearch", value: function () {
                    h.removeClass(this.$allWrappers, "has-no-search-results"), h.addClass(this.$allWrappers, "server-searching"), this.setSelectedOptions(), this.onServerSearch(this.searchValue, this)
                }
            }, {
                key: "removeValue", value: function (e) {
                    var t = this.selectedValues, i = h.getData(e, "value");
                ...
                key: "enable", value: function () {
                    this.$ele.disabled = !1, this.$ele.removeAttribute("disabled"), this.$hiddenInput.removeAttribute("disabled"), h.setAria(this.$wrapper, "disabled", !1)
                }
            }, {
                key: "disable", value: function () {
                    this.$ele.disabled = !0, this.$ele.setAttribute("disabled", ""), this.$hiddenInput.setAttribute("disabled", ""), h.setAria(this.$wrapper, "disabled", !0)
                }
            }, {
                key: "validate", value: function () {
                    if (this.disableValidation) return !0;
                    var e = !1, t = this.selectedValues, i = this.minValues;
                    return this.required && (s.isEmpty(t) || this.multiple && i && t.length < i) && (e = !0), h.toggleClass(this.$allWrappers, "has-error", e), !e
                }
            }, {
                key: "destroy", value: function () {
                    var e = this.$ele;
                    e.virtualSelect = void 0, e.value = void 0, e.innerHTML = "", this.hasDropboxWrapper && (this.$dropboxWrapper.remove(), this.mutationObserver.disconnect()), this.dropboxPopover && this.dropboxPopover.destroy(), h.removeClass(e, "vscomp-ele")
                }
            }, {
                ...
                key: "toggleOptionSelectedState", value: function (e, t) {
                    var i = t;
                    void 0 === i && (i = !h.hasClass(e, "selected")), h.toggleClass(e, "selected", i), h.setAria(e, "selected", i)
                }
            }, {
                key: "toggleOptionFocusedState", value: function (e, t) {
                    e && (h.toggleClass(e, "focused", t), t && h.setAria(this.$wrapper, "activedescendant", e.id))
                }
            }]) && O(t.prototype, i), o && O(t, o), Object.defineProperty(t, "prototype", {writable: !1}), e
        }();
    ...
    var i = function () {
        ...
        return (t = [{
            ...
            key: "setPosition", value: function () {
                ...
                if (E = j.top, k = j.left, A && ("top" === A ? E = x : "bottom" === A ? E = x + b - h : "left" === A ? k = w : "right" === A && (k = w + y - p)), k < M ? "left" === C ? n = "right" : k = M + f > m ? m - f : M : k + p > F && ("right" === C ? n = "left" : k = F + f < S ? S - d : F - p), E < P ? "top" === C ? n = "bottom" : E = P + c > O ? O - c : P : E + h > I && ("bottom" === C ? n = "top" : E = I + c < g ? g - v : I - h), n) {
                    var W = H[n];
                    "top" === (C = n) || "bottom" === C ? E = W.top : "left" !== C && "right" !== C || (k = W.left)
                }
                "top" === C ? (e = E + V, t = k) : "right" === C ? (e = E, t = k - V) : "left" === C ? (e = E, t = k + V) : (e = E - V, t = k);
                var L = "translate3d(".concat(t, "px, ").concat(e, "px, 0)");
                if (i.setStyle(this.$popperEle, "transform", L), i.setData(this.$popperEle, "fromLeft", t), i.setData(this.$popperEle, "fromTop", e), i.setData(this.$popperEle, "top", E), i.setData(this.$popperEle, "left", k), i.removeClass(this.$popperEle, o.join(" ")), i.addClass(this.$popperEle, "position-".concat(C)), this.hasArrow) {
                    var N = 0, q = 0, R = k + f, B = E + c, z = this.$arrowEle.offsetWidth / 2, K = s[C] || "";
                    "top" === C || "bottom" === C ? (N = y / 2 + S - R) < z ? N = z : N > p - z && (N = p - z) : "left" !== C && "right" !== C || ((q = b / 2 + g - B) < z ? q = z : q > h - z && (q = h - z)), i.setStyle(this.$arrowEle, "transform", "translate3d(".concat(N, "px, ").concat(q, "px, 0) ").concat(K))
                }
