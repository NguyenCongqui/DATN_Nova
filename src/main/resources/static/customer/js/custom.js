  ...
  e(function () {
    ...
    a.on("mouseenter mouseleave", function (a) {
      ...
      t.on("click", function (i) {
        e(".navigation-menu > ul").toggleClass("show-on-mobile"),
          i.preventDefault();
      });
  }),
    e(function () {
    ...
    i.bind("DOMContentLoaded load resize", function () {
      ...
      i.innerWidth() <= parseInt(979)
        ...
        : (e("#header-sticky").removeClass("no-stick"),
          e(".header").css("height", a));
    }),
    e(function () {
      ...
      if (
        ...
        e(function () {
          ...
          i.on("click", function (i) {
            ...
            a.on("click keyup", function (i) {
              (i.target != this &&
                "search-overlay-close" != i.target.className &&
                27 != i.keyCode) ||
        ...
        e(".slide-bg-image, .bg-image").each(function (i) {
          e(this).attr("data-background-img") &&
            e(this).css(
              "background-image",
              "url(" + e(this).data("background-img") + ")"
            ),
            e(this).attr("data-bg-position-x") &&
              e(this).css("background-position", e(this).data("bg-position-x"));
        }),
        i.width() > parseInt(979))
      ) {
        ...
        e(".nlpopup_close, #nlpopup_overlay").on("click", function (i) {
          e.cookie("nlpopup", "closed", { expires: l, path: "/" }),
      ...
      e("ul.jq-accordian > li:has( > ul ) > a").append(
        ...
        e("ul.jq-accordian > li:has( > ul ) > a").attr(
          "href",
          "javascript:void(0)"
        ),
      ...
      c.on("click", function (i) {
        c.each(function (i) {
          ...
          (i = e(i.target)).next().is("ul") && i.next().is(":visible")
            ? i.next().slideUp()
            : i.next().slideDown();
      }),
        c.on("click", function (i) {
          e(this).hasClass("is-active")
            ...
            : (u.not(this).removeClass("is-active"),
        ...
        e(function () {
          ...
          e(".price-range-slider").slider({
            ...
            e("#price_range_min").val(
              e(".price-range-slider").slider("values", 0)
            ),
            e("#price_range_max").val(
              e(".price-range-slider").slider("values", 1)
            );
        }),
        e(function () {
