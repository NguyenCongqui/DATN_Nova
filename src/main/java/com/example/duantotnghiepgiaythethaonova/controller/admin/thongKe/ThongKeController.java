...
public class ThongKeController {
    ...
    public @ResponseBody
    ResponseEntity<?> fetchChartData(@RequestParam @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate startDate,
    ...
    public @ResponseBody
    ResponseEntity<?> fetchStatistictData(@RequestParam @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate startDate,
                                          @RequestParam @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate endDate) {
